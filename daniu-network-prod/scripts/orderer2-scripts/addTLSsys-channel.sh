...
ORDERER_CA=/opt/gopath/src/github.com/hyperledger/fabric/peer/organizations/ordererOrganizations/niuinfo.com/orderers/orderer.niuinfo.com/msp/tlscacerts/tlsca.niuinfo.com-cert.pem

peer channel fetch config config_block.pb -o orderer.niuinfo.com:7050 -c system-channel --tls --cafile $ORDERER_CA
...
peer channel update -f config_update_in_envelope.pb -c system-channel -o orderer.niuinfo.com:7050 --tls true --cafile $ORDERER_CA