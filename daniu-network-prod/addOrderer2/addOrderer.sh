...
docker exec orderer.niuinfo.com ls -lh /var/hyperledger/production/orderer/chains/system-channel
docker exec orderer2.niuinfo.com ls -lh /var/hyperledger/production/orderer/chains/system-channel

echo "Application channel Size (before channel update)"
docker exec orderer.niuinfo.com ls -lh /var/hyperledger/production/orderer/chains/mychannel
docker exec orderer2.niuinfo.com ls -lh /var/hyperledger/production/orderer/chains/mychannel
